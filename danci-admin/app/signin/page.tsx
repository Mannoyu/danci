...
export default function SignInPage() {
  ...
  useEffect(() => {
    fetch("/api/auth/session").then((response) => {
      if (response.ok) router.replace("/books");
    });
  }, [router]);
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <button
              ...
              className="absolute inset-y-0 right-0 grid w-10 place-items-center text-muted-foreground hover:text-foreground focus-visible:outline-2 focus-visible:outline-offset-[-2px] focus-visible:outline-ring"
